...
2. 实习生入职材料   
	...
	* 身份证、学生证（原件及复印件2份）
	* 2寸白底彩色照片 1 张
	* 本人深圳工商银行卡原件和复印件1份（复印件上写明开户人、开户城市、银行卡号)(**仅限工作地为深圳的同学，工作地为广州、成都及其他地区，请准备当地招行卡**)。在万利达楼下有银行,带上身份证去办理即可。**注意：需要先办理银行卡，之后才能办理入职手续。**
3. 加入咨询渠道   
	* 实习生沟通群组（Q群）  
...
夜宵券在各个食堂晚餐的时候都可以使用,通常情况下每餐一张夜宵券,个别餐点需要多张夜宵券。深圳地区,在腾讯大厦附近有一家麦当劳,也可以使用夜宵券,每张夜宵券价值 20 元,点餐超过20元可用现金补，不够20元的话都是扣一张夜宵券（如果点餐金额太少建议不使用夜宵券，直接刷现金）。

### 电脑设备

公司普遍还是windows电脑。也可以自己带笔记本，如果要想连接公司内网，去[8000](http://8000.oa.com/ioa/)下载相应的ioa软件自行入域，[入域指引](http://8000.oa.com/#/article?id=KB201511030001)。

### 相关软件及IT服务
[新员工IT服务指引](http://8000.oa.com/#/productDetail/P2016032102)  
[申请VPN](http://8000.oa.com/#/article?id=KB201412080003)  
[申请跳板机MNET](http://8000.oa.com/#/article?id=KB201506190006)  
[正版office下载及授权](http://8000.oa.com/#/productDetail/P2017071701)请勿使用盗版  
如果有显示XXX站点无法访问，请向leader[申请网页权限](http://office.oa.com/applyfill.aspx?flowid=153)
