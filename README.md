...
#### PIN+token
入职当天,会发放一个“QQ 令牌”。需要先使用英文名和 outlook 密码登录 token.oa.com (如无权限,可座机电话 8008)。
...
公司普遍还是windows电脑。也可以自己带笔记本，不过要想连接公司内网，需要在8008登记并下载ioa入域。

### 班车
刚来的前一两天，班车有时无法刷卡，可能 8008 那边没有弄好权限,可以和司机说一声刚入职即可。
#### 班车查询
...
* [8008.oa.com](8008.oa.com) :腾讯专属 IT 支持,8008 知识库能帮你解决大部分电脑问题。 
* [holiday.oa.com/v2](holiday.oa.com/v2) :实习生签到

### 其他 Q & A   
Q - 电脑出故障了,怎么办?    
A - RTX 或者座机找 8008,或者访问 8008 知识库查询。

Q - 有些内部的网站没有权限(例如 cost.oa.com)?    
A - 按照步骤申请即可,一般都会通过。Office.oa.com 进行申请。如果是 8008.oa.com 或者 token.oa.com,则可以直接用导师或者周围同事的座机打 8008 要权限。
